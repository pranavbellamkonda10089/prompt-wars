...
export const TrapComparisonModal: React.FC<TrapComparisonModalProps> = ({
  isOpen,
  onClose
}) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto glass-panel bg-slate-950/95 border border-indigo-500/40 rounded-3xl p-6 shadow-2xl space-y-6">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="space-y-1.5 pr-8">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/40 text-xs font-semibold">
            ...
            <span>Core Evaluation Benchmark: The Built-in Trap</span>
          </div>
